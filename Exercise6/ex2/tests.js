...
var tests = {
    ...
    shouldReturnFalse1: function () {
        this._multiset.add(2);
        this._multiset.add(true);
        assert(this._multiset.remove(42), false);
    },
    ...
    shouldReturnTrue: function () {
        ...
        this._multiset.add(true);
        this._multiset.add(42);
        return assert(this._multiset.remove(42), true);
    },
    shouldReturn0: function () {
        this._multiset.add(2);
        this._multiset.add(true);
        assert(this._multiset.remove(42, 1), 0);
        this._multiset.add(2);
        this._multiset.add(true);
        this._multiset.add("42");
        assert(this._multiset.remove(42, 1), 0);
    ...
    shouldReturn1: function () {
        ...
        this._multiset.add(42);
        this._multiset.add(42);
        assert(this._multiset.remove(42, 1), 1);
    },
    shouldReturn3_1: function () {
        ...
        this._multiset.add(42);
        this._multiset.add(42);
        assert(this._multiset.remove(42, 3), 3);
    },
    shouldReturn3_2: function () {
        ...
        this._multiset.add(42);
        this._multiset.add(42);
        assert(this._multiset.remove(42, 5), 3);
    }
};
...
var testRunner = function () {
    ...
    for (var t in tests) {
        ...
        if (res.success === false) {
            errors++;
            document.getElementById("messages").innerHTML = document.getElementById("messages").innerHTML + "<li>" + t + " - " + res.message + "</li>";
