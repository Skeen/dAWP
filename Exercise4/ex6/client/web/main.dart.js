...
["dart._internal", "dart:_internal", , H, {
  ...
  SubListIterable: {
    ...
    skip$1: function(_, count) {
      return H.SubListIterable$(this._iterable, this.__internal$_start + count, this._endOrLength, H.getTypeArgumentByIndex(this, 0));
    },
...
["dart.async", "dart:async", , P, {
  ...
  _Completer: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 22, 6]
  },
  _AsyncCompleter: {
    "^": "_Completer;future",
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:29;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["link_handler", "package:route_hierarchical/click_handler.dart", , V, {
  ...
  DefaultWindowClickHandler: {
    "^": "Object:12;_linkMatcher,_router,_normalizer,_link_handler$_window,_link_handler$_useFragment",
...
["", "main.dart", , F, {
  "^": "",
  main: [function() {
    var t1 = $.get$router().root;
    t1.addRoute$3$enter$name$path(F.showImage$closure(), "image", "/image");
    t1.addRoute$4$defaultRoute$enter$name$path(true, F.showGallery$closure(), "gallery", "/");
    $.get$router().listen$0();
    t1 = J.get$onClick$x(document.querySelector("#submitComment"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.submitComment$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    W.HttpRequest_getString("http://localhost:4111/list_images", null, null).then$1(F.onImagesLoaded$closure());
  }, "call$0", "main$closure", 0, 0, 3],
  submitComment: [function($event) {
    W.HttpRequest_getString("http://localhost:4111/post_comment?imageID=1&comment=LOL", null, null);
  }, "call$1", "submitComment$closure", 2, 0, 12],
  showImage: [function(e) {
    J.set$display$x(document.querySelector("#gallery").style, "none");
    J.set$display$x(document.querySelector("#image").style, "");
  }, "call$1", "showImage$closure", 2, 0, 13],
  showGallery: [function(e) {
    J.set$display$x(document.querySelector("#gallery").style, "");
    J.set$display$x(document.querySelector("#image").style, "none");
  }, "call$1", "showGallery$closure", 2, 0, 13],
  onImagesLoaded: [function(responseText) {
    J.get$children$x($.get$galleryContainer()).clear$0(0);
    J.forEach$1$ax(C.JsonCodec_null_null.decode$1(responseText), new F.onImagesLoaded_closure());
  }, "call$1", "onImagesLoaded$closure", 2, 0, 14],
  loadImage: function(id) {
    $.get$router().gotoUrl$1("image");
    J.get$children$x($.get$commentsList()).clear$0(0);
    W.HttpRequest_getString(C.JSString_methods.$add("http://localhost:4111/get_comments?imageID=", J.toString$0(id)), null, null).then$1(new F.loadImage_closure());
  },
  loadComment: [function(comment) {
    var li = document.createElement("li", null);
    li.textContent = comment;
    J.get$children$x($.get$commentsList()).add$1(0, li);
  }, "call$1", "loadComment$closure", 2, 0, 14],
  onImagesLoaded_closure: {
    "^": "Closure:16;",
    call$2: function(id, url) {
      var e, t1;
      e = document.createElement("img", null);
      if (url != null)
        J.set$src$x(e, url);
      t1 = J.get$onClick$x(e);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.onImagesLoaded__closure(id)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      J.get$children$x($.get$galleryContainer()).add$1(0, e);
    }
  },
  onImagesLoaded__closure: {
    "^": "Closure:17;id_0",
    call$1: function($event) {
      F.loadImage(this.id_0);
    }
  },
  loadImage_closure: {
    "^": "Closure:17;",
    call$1: function(responseString) {
      J.forEach$1$ax(C.JsonCodec_null_null.decode$1(responseString), F.loadComment$closure());
    }
  }
},
1],
["route.client", "package:route_hierarchical/client.dart", , D, {
  ...
  Router: {
    ...
    }, "route$1", "call$2$startingFrom", "call$1", "get$route", 2, 3, 32, 6],
  ...
  Router__preLeave_closure0: {
    "^": "Closure:33;box_0,this_2,path_3,treePath_4,leaveBase_5,activePath_6,baseRoute_7",
  ...
  Router__preLeave__closure0: {
    "^": "Closure:15;box_0,this_8,leaveBase_9",
    call$0: function() {
  ...
  Router__preEnter_closure0: {
    "^": "Closure:33;box_0,this_2,leaveFn_3",
    call$1: function(results) {
      var t1;
  ...
  Router__parseQuery_closure: {
    "^": "Closure:19;this_0,route_1,params_2",
    ...
    call$1: function(success) {
      ...
      if (success === true) {
        ...
        if (t1._useFragment)
          ...
          title = J.get$title$x(t1._window.document);
...
["route.utils", "package:route_hierarchical/src/utils.dart", , U, {
  ...
  mapsShallowEqual: function(a, b) {
    return J.$eq(a.get$length(a), b.get$length(b)) && a.get$keys().every$1(0, new U.mapsShallowEqual_closure(a, b));
  },
...
Isolate.$lazy($, "galleryContainer", "galleryContainer", "get$galleryContainer", function() {
  return document.querySelector("#galleryContainer");
});
Isolate.$lazy($, "commentsList", "commentsList", "get$commentsList", function() {
...
Isolate.$lazy($, "router", "router", "get$router", function() {
  ...
  t3 = window;
  t1 = new D.Router(t2, t3, D.RouteImpl$_new(false, null, null, null), t1, true, false, null);
